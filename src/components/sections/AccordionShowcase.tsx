...
const accordionData = [
  {
    ...
    description: 'Cracks, UV damage, and surface aging don\'t fix themselves. Every year you wait, the damage gets worse — and the bill gets bigger.',
    stat: '87%',
  ...
  },
  {
    ...
    description: 'Roof Protector sprays on in a single coat. Penetrates deep, bonds to the surface. Your roof is done before sunset.',
    stat: '200',
  ...
  },
  {
    ...
    description: 'Protected and backed by a 15-year warranty. Not a patch job — a full restoration. Looks new, performs new.',
    stat: '15',
  ...
  },
  {
    ...
    description: 'ASTM E84 fire rating. 250% elongation. Zero VOC. This is professional-grade coating for your home — without the aerospace price tag.',
    stat: '0',
